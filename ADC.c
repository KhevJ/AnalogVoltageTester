 ...
 *
 * Created on November 9, 2022, 3:58 AM
 */
...
//	AD1CON2bits.BUFS=1;	//ADC is filling ADC1BUF8-BUFF. Access data in BUF0-7
    ...
    AD1PCFG=0xFFDF; //Set all bits as digital
...
uint16_t do_ADC(void)
{
    ...
    ADC_init(); //initialize adc interrupts and other adc configurations
	...
	ADCvalue=ADC1BUF0; //ADCvalue = adcbuff
